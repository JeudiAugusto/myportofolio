...
class MainTest(TestCase):
    def setUp(self):
        self.experience = Experience.objects.create(
            title="Cashie - Finance Web App Project",
            description=(
                "Mengembangkan aplikasi web pengelola keuangan "
                "menggunakan PHP, JavaScript, SQL, CRUD, dan AJAX."
            ),
            category="freelance",
        )
    ...
    def test_experience_model(self):
        self.assertEqual(
            str(self.experience),
            "Cashie - Finance Web App Project",
        )
